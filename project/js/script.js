let open = document.getElementById('open-btn'),
	...
	open_switch = document.getElementById('open-switch');
	open_label = document.getElementsByClassName('open-label')[0];
...
timeValue.addEventListener('input', () => {
	...
	if (mainList.isOpen == true) {
		open_switch.checked = true;
	} else {
		open_switch.checked = false;
	};
});

open_label.addEventListener('click', function (event) {
